...
const Trending = () => {
  ...
  return (
    <>
      <CrptoTicker />
    <div className="container mx-auto p-6 flex flex-col text-xs md:flex-row gap-6">
      {/* Top Gainers & Losers */}
      ...
      {/* Title */}
      <h2 className="text-green-400 text-lg font-semibold mb-4">Stable Coins</h2>
    ...
    <div className="bg-gray-800 text-white p-4 rounded-lg w-full">
      {/* Title */}
      <h2 className="text-green-400 text-lg font-semibold mb-4">Upcoming Coins</h2>
